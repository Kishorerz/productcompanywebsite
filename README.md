...
<footer style="background-color:rgb(233, 154, 7);margin-top:240 ; border: none;">
    <P style="color:#0b0a0a; ;"align="center">Designed and Devoloped by KISHOR KUMAR B (212223240072) </P>
</footer>
</html>
```
...
<html>
    ...
    <body>
        ...
        <img src="..//static/img/keyboard.jpg" height="200" width="200">
        </div>
           
        <img src="../static/img/headphone.jpg" height="200" width="200">
        </div>
            
        <img src="../static/img/phone.jpg" height="200" width="200">
        </div>
           
        <img src="../static/img/fan.jpg" height="200" width="200">
        </div>
           
        <img src="../static/img/cycle.jpg" height="200" width="200">
        </div>
    ...
    <footer style="background-color:rgb(255, 123, 0);margin-top: 170; border: none;">
        <P style="color:black; ;"align="center">Designed and Devoloped by KISHOR KUMAR B. (212223240072) </P>
    </footer>
</html>
...
<footer style="background-color:rgb(229, 104, 21);margin-top: 235; border: none;">
    <P style="color:#080707; ;"align="center">Designed and Devoloped by KISHOR KUMAR B (212223240072) </P>
</footer>
</html>
...
<body>
    ...
    <div class="company">
       ...
       <p> <b >Address</b></p>
        ...
        <p >Chennai-600114</p>
        <b >Email:</b>
        <p >baskarankishorekumar@gmail.com</p>
        <b >Phone</b>
        <p >6381973313</p>
    </center>
    </div>
